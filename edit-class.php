...
$sql="update  class_table set ClassName=:classname,ClassNameNumeric=:classnamenumeric,Section=:section where id=:cid ";
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <?php 
                                $cid=intval($_GET['classid']);
                                $sql = "SELECT * from class_table where id=:cid";
                                $query = $dbh->prepare($sql);
                                $query->bindParam(':cid',$cid,PDO::PARAM_STR);
                                $query->execute();
                                ...
                                {   ?>
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="classname" class="form-control" value="<?php echo htmlentities($result->ClassName);?>"
                                                id="exampleInputEmail1" placeholder="Enter email">
                                            <span class="form-text text-muted">Example- 1aad, 2aad, 3aad</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputname">Class Name in Numeric</label>
                                            <input type="text" name="classnamenumeric" value="<?php echo htmlentities($result->ClassNameNumeric);?>" class="form-control"
                                                id="exampleInputname" placeholder="Password">
                                            <span class="form-text text-muted">Example- 1,2,4,5 etc</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputname">Section</label>
                                            <input type="text" name="section" value="<?php echo htmlentities($result->Section);?>" class="form-control" id="exampleInputname"
