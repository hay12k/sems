                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT  distinct students_table.StudentName,students_table.RollId,students_table.RegDate,students_table.StudentId,students_table.Status,class_table.ClassName,class_table.Section from result_table join students_table on students_table.StudentId=result_table.StudentId  join class_table on class_table.id=result_table.ClassId";
