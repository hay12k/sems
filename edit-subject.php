...
$sql="update  subject_table set SubjectName=:subjectname,SubjectCode=:subjectcode where id=:sid";
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="#">Subjucts</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <?php
                                    $sid=intval($_GET['subjectid']);
                                    $sql = "SELECT * from subject_table where id=:sid";
                                    $query = $dbh->prepare($sql);
                                    $query->bindParam(':sid',$sid,PDO::PARAM_STR);
                                    $query->execute();
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="subjectname" value="<?php echo htmlentities($result->SubjectName);?>" class="form-control"
                                                id="exampleInputEmail1" placeholder="Subject Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputname">Subject Code</label>
                                            <input type="text" name="subjectcode" value="<?php echo htmlentities($result->SubjectCode);?>" class="form-control"
