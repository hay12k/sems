...
$status=1;
$sql="update subject_by_class_table set status=:status where id=:acid ";
...
$did=intval($_GET['did']);
$status=0;
$sql="update subject_by_class_table set status=:status where id=:did ";
$query = $dbh->prepare($sql);
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT class_table.ClassName,class_table.Section,subject_table.SubjectName,subject_by_class_table.id as scid,subject_by_class_table.status from subject_by_class_table join class_table on class_table.id=subject_by_class_table.ClassId  join subject_table on subject_table.id=subject_by_class_table.SubjectId";
                                          $query = $dbh->prepare($sql);
                                          $query->execute();
