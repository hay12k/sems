...
if(strlen($_SESSION['alogin'])==""){   
    header("Location: index.php"); 
      ...
      if(isset($_POST['add_teacher'])){
        ...
        $sql="INSERT INTO `admin`(`full_name`, `UserName`, `Password`,`role`,`status`, `createdDate`) VALUES ('$teacher_name','$teacher_user_name','$password','$role','$status','$date')";
                                ...
                                <form role="form" id="quickForm" method="POST">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="teacher_user_name" class="form-control"
                                                id="exampleInputname" placeholder="User Name" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputname">Password</label>
                                            <input type="password" name="password" class="form-control"
                                                id="exampleInputname" placeholder="Password" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="radio" name="status" id="status" checked id="radioSuccess1"
                                                value="1"> Active
                                            &nbsp;
                                            <input type="radio" name="status" id="status" id="radioSuccess2" value="0">
                                            inActive
                                        </div>
